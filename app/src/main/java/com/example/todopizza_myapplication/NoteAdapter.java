...
public class NoteAdapter extends RecyclerView.Adapter<NoteAdapter.ViewHolder> {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView){
            ...
            gpimentoToppings = itemView.findViewById(R.id.gpimentoToppings);
            layoutTodo = itemView.findViewById(R.id.layoutTodo);
            checkBox = itemView.findViewById(R.id.checkBox);
            deleteButton = itemView.findViewById(R.id.deleteButton);
            topping_spinner = (ImageView) itemView.findViewById(R.id.topping_spinner);


            Log.d("mytag1",""+myimg);
            if(myimg == "gpimento"){
                imageResourceId = R.drawable.gpimento;
            }else if(myimg == "ham"){
                imageResourceId = R.drawable.ham;
            }
        ...
        public void setItem(Note item){
            ...
            topping_spinner.setImageResource(imageResourceId);//여기에 저 그걸 받아서 넣어야해.
        }
